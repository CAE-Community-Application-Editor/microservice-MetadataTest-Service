...
/**
 *
 * MetadataTest-Service - Test Class
 *
 * This class provides a basic testing framework for the microservice MetadataTest-Service. It was
...
public class resTest {
  ...
  public void testm1() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/m1", "",
        MediaType.TEXT_PLAIN, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testm1': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
